...
public class ReportEngineTest {
    ...
    public void whenGeneratedXML() {
        ...
        String expect = "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>\n"
                ...
                + " hired=\"" + SDF.format(worker.getHired().getTime()) + "\""
                + " fired=\"" + SDF.format(worker.getFired().getTime()) + "\""
                + " salary=\"" + worker.getSalary() + "\"/>\n"
                + "    <employee name=\"" + worker2.getName() + "\""
                + " hired=\"" + SDF.format(worker2.getHired().getTime()) + "\""
                + " fired=\"" + SDF.format(worker2.getFired().getTime()) + "\""
